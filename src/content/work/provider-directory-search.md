...
![After: the rebuilt directory with Filter by Specialty and Filter by Name toggle buttons above a search input. As a name is typed, results filter in real time and the matching specialty groups expand automatically.](../../assets/projects/provider-search.gif)
